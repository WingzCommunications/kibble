var SearchBox = new function(){
	...
	this.showMessage = function(message, options)
	{
		...
		this.container = jQuery(document.createElement("div")).attr("class", "search-box");
		...
		if (this.isIE6)
		{
			...
			this.container.addClass("search-box-ie6");
		}
		else
		{
	...
	{
		var result = jQuery(document.createElement("div")).attr("class", "search-box-modal").fadeTo(0,0).css("height", jQuery(window).height());
